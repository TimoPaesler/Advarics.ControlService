...
//    code is regenerated.
// 
//    Generated at: 06.06.2019 16:04:19
//    DevForce version: 7.5.2.0
...
[module: IbCore.IdeaBladeLicense("CM/CZO1q11pA6+XfdsO4r6in7FSMr7bN10SVCS2ECFqhDNCiffBH7XiuQtpS+Q69")]
...
namespace Advarics.ControlService { 
  ...
  public partial class CashPoint : IbEm.Entity {
    ...
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="Culture", AutoGenerateField=true)]
    [IbVal.StringLengthVerifier(MaxValue=10, IsRequired=false, ErrorMessageResourceName="CashPoint_Culture")]
    public string Culture {
      get { return PropertyMetadata.Culture.GetValue(this); }
      set { PropertyMetadata.Culture.SetValue(this, value); }
    }

    /// <summary>Gets or sets the CustomerMergeTimeStamp. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="CustomerMergeTimeStamp", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="CashPoint_CustomerMergeTimeStamp")]
    public System.DateTime CustomerMergeTimeStamp {
      get { return PropertyMetadata.CustomerMergeTimeStamp.GetValue(this); }
      set { PropertyMetadata.CustomerMergeTimeStamp.SetValue(this, value); }
    }

    /// <summary>Gets or sets the CustomerMergeSyncMaxId. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="CustomerMergeSyncMaxId", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="CashPoint_CustomerMergeSyncMaxId")]
    public long CustomerMergeSyncMaxId {
      get { return PropertyMetadata.CustomerMergeSyncMaxId.GetValue(this); }
      set { PropertyMetadata.CustomerMergeSyncMaxId.SetValue(this, value); }
    }

    /// <summary>Gets or sets the ItemMergeTimeStamp. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="ItemMergeTimeStamp", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="CashPoint_ItemMergeTimeStamp")]
    public System.DateTime ItemMergeTimeStamp {
      get { return PropertyMetadata.ItemMergeTimeStamp.GetValue(this); }
      set { PropertyMetadata.ItemMergeTimeStamp.SetValue(this, value); }
    }

    /// <summary>Gets or sets the ItemMergeSyncMaxId. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="ItemMergeSyncMaxId", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="CashPoint_ItemMergeSyncMaxId")]
    public long ItemMergeSyncMaxId {
      get { return PropertyMetadata.ItemMergeSyncMaxId.GetValue(this); }
      set { PropertyMetadata.ItemMergeSyncMaxId.SetValue(this, value); }
    }
    ...
    public partial class PropertyMetadata {
      ...
      /// <summary>The Culture <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<CashPoint, string> Culture = new IbEm.DataEntityProperty<CashPoint, string>("Culture", true, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The CustomerMergeTimeStamp <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<CashPoint, System.DateTime> CustomerMergeTimeStamp = new IbEm.DataEntityProperty<CashPoint, System.DateTime>("CustomerMergeTimeStamp", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The CustomerMergeSyncMaxId <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<CashPoint, long> CustomerMergeSyncMaxId = new IbEm.DataEntityProperty<CashPoint, long>("CustomerMergeSyncMaxId", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The ItemMergeTimeStamp <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<CashPoint, System.DateTime> ItemMergeTimeStamp = new IbEm.DataEntityProperty<CashPoint, System.DateTime>("ItemMergeTimeStamp", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The ItemMergeSyncMaxId <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<CashPoint, long> ItemMergeSyncMaxId = new IbEm.DataEntityProperty<CashPoint, long>("ItemMergeSyncMaxId", false, false, IbEm.ConcurrencyStrategy.None, false, null);
    ...
    public new partial class EntityPropertyNames : IbEm.Entity.EntityPropertyNames {
      ...
      public const String CustomerMergeTimeStamp = "CustomerMergeTimeStamp";
      public const String CustomerMergeSyncMaxId = "CustomerMergeSyncMaxId";
      public const String ItemMergeTimeStamp = "ItemMergeTimeStamp";
      public const String ItemMergeSyncMaxId = "ItemMergeSyncMaxId";
  ...
  public partial class Store : IbEm.Entity {
    ...
    /// <summary>Gets or sets the ReceiptFooterRtf. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="ReceiptFooterRtf", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="Store_ReceiptFooterRtf")]
    public string ReceiptFooterRtf {
      get { return PropertyMetadata.ReceiptFooterRtf.GetValue(this); }
      set { PropertyMetadata.ReceiptFooterRtf.SetValue(this, value); }
    }

    /// <summary>Gets or sets the FiscalYearStartMonth. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="FiscalYearStartMonth", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="Store_FiscalYearStartMonth")]
    public int FiscalYearStartMonth {
      get { return PropertyMetadata.FiscalYearStartMonth.GetValue(this); }
      set { PropertyMetadata.FiscalYearStartMonth.SetValue(this, value); }
    }

    /// <summary>Gets or sets the HouseType. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="HouseType", AutoGenerateField=true)]
    [IbVal.StringLengthVerifier(MaxValue=50, IsRequired=true, ErrorMessageResourceName="Store_HouseType")]
    public string HouseType {
      get { return PropertyMetadata.HouseType.GetValue(this); }
      set { PropertyMetadata.HouseType.SetValue(this, value); }
    }

    /// <summary>Gets or sets the TransportStoreId. </summary>
    [DataMember]
    [Bindable(false)]
    [Editable(true)]
    [Display(Name="TransportStoreId", AutoGenerateField=false)]
    public System.Nullable<long> TransportStoreId {
      get { return PropertyMetadata.TransportStoreId.GetValue(this); }
      set { PropertyMetadata.TransportStoreId.SetValue(this, value); }
    }

    /// <summary>Gets or sets the StartNoReturns. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="StartNoReturns", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="Store_StartNoReturns")]
    public long StartNoReturns {
      get { return PropertyMetadata.StartNoReturns.GetValue(this); }
      set { PropertyMetadata.StartNoReturns.SetValue(this, value); }
    }

    /// <summary>Gets or sets the EndNoReturns. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="EndNoReturns", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="Store_EndNoReturns")]
    public long EndNoReturns {
      get { return PropertyMetadata.EndNoReturns.GetValue(this); }
      set { PropertyMetadata.EndNoReturns.SetValue(this, value); }
    }

    /// <summary>Gets or sets the ReturnsNo. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="ReturnsNo", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="Store_ReturnsNo")]
    public long ReturnsNo {
      get { return PropertyMetadata.ReturnsNo.GetValue(this); }
      set { PropertyMetadata.ReturnsNo.SetValue(this, value); }
    }
    #endregion Data Properties
    ...
    /// <summary>Gets the Store1. </summary>
    [DataMember]
    [Bindable(false)]
    [Display(Name="Store1", AutoGenerateField=false)]
    public IbEm.RelatedEntityList<Store> Store1 {
      get { return PropertyMetadata.Store1.GetValue(this); }
    }

    /// <summary>Gets or sets the Store2. </summary>
    [DataMember]
    [Bindable(false)]
    [Display(Name="Store2", AutoGenerateField=false)]
    public Store Store2 {
      get { return PropertyMetadata.Store2.GetValue(this); }
      set { PropertyMetadata.Store2.SetValue(this, value); }
    }
    #endregion Navigation properties
    ...
    public partial class PropertyMetadata {
      ...
      /// <summary>The ReceiptFooterRtf <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, string> ReceiptFooterRtf = new IbEm.DataEntityProperty<Store, string>("ReceiptFooterRtf", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The FiscalYearStartMonth <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, int> FiscalYearStartMonth = new IbEm.DataEntityProperty<Store, int>("FiscalYearStartMonth", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The HouseType <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, string> HouseType = new IbEm.DataEntityProperty<Store, string>("HouseType", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The TransportStoreId <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, System.Nullable<long>> TransportStoreId = new IbEm.DataEntityProperty<Store, System.Nullable<long>>("TransportStoreId", true, false, IbEm.ConcurrencyStrategy.None, false, "Store2");

      /// <summary>The StartNoReturns <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, long> StartNoReturns = new IbEm.DataEntityProperty<Store, long>("StartNoReturns", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The EndNoReturns <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, long> EndNoReturns = new IbEm.DataEntityProperty<Store, long>("EndNoReturns", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The ReturnsNo <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<Store, long> ReturnsNo = new IbEm.DataEntityProperty<Store, long>("ReturnsNo", false, false, IbEm.ConcurrencyStrategy.None, false, null);
      ...
      /// <summary>The Store1 <see cref="T:IbEm.NavigationEntityProperty"/>. </summary>
      public static readonly IbEm.NavigationListEntityProperty<Store, Store> Store1 = new IbEm.NavigationListEntityProperty<Store, Store>("Store1", true, "FK_Store_Store", IbEm.QueryDirection.ToRole1);

      /// <summary>The Store2 <see cref="T:IbEm.NavigationEntityProperty"/>. </summary>
      public static readonly IbEm.NavigationScalarEntityProperty<Store, Store> Store2 = new IbEm.NavigationScalarEntityProperty<Store, Store>("Store2", true, "FK_Store_Store", IbEm.QueryDirection.ToRole2);
    }
    #endregion EntityProperty definitions
    ...
    public new partial class EntityPropertyNames : IbEm.Entity.EntityPropertyNames {
      ...
      public const String ReceiptFooterRtf = "ReceiptFooterRtf";
      public const String FiscalYearStartMonth = "FiscalYearStartMonth";
      public const String HouseType = "HouseType";
      public const String TransportStoreId = "TransportStoreId";
      public const String StartNoReturns = "StartNoReturns";
      public const String EndNoReturns = "EndNoReturns";
      public const String ReturnsNo = "ReturnsNo";
      public const String CashPoints = "CashPoints";
      public const String Store1 = "Store1";
      public const String Store2 = "Store2";
    }
    #endregion EntityPropertyNames
  }
  ...
  public partial class BackgroundWorkerStatu : IbEm.Entity {
    ...
    [Editable(true)]
    [Display(Name="Status", AutoGenerateField=true)]
    [IbVal.RequiredValueVerifier( ErrorMessageResourceName="BackgroundWorkerStatu_Status")]
    public int Status {
      get { return PropertyMetadata.Status.GetValue(this); }
      set { PropertyMetadata.Status.SetValue(this, value); }
    }

    /// <summary>Gets or sets the LastLifeSign. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="LastLifeSign", AutoGenerateField=true)]
    public System.Nullable<System.DateTime> LastLifeSign {
      get { return PropertyMetadata.LastLifeSign.GetValue(this); }
      set { PropertyMetadata.LastLifeSign.SetValue(this, value); }
    }

    /// <summary>Gets or sets the BaseDirectory. </summary>
    [DataMember]
    [Bindable(true, BindingDirection.TwoWay)]
    [Editable(true)]
    [Display(Name="BaseDirectory", AutoGenerateField=true)]
    [IbVal.StringLengthVerifier(MaxValue=255, IsRequired=true, ErrorMessageResourceName="BackgroundWorkerStatu_BaseDirectory")]
    public string BaseDirectory {
      get { return PropertyMetadata.BaseDirectory.GetValue(this); }
      set { PropertyMetadata.BaseDirectory.SetValue(this, value); }
    }
    #endregion Data Properties
    ...
    public partial class PropertyMetadata {
      ...
      /// <summary>The Status <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<BackgroundWorkerStatu, int> Status = new IbEm.DataEntityProperty<BackgroundWorkerStatu, int>("Status", false, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The LastLifeSign <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<BackgroundWorkerStatu, System.Nullable<System.DateTime>> LastLifeSign = new IbEm.DataEntityProperty<BackgroundWorkerStatu, System.Nullable<System.DateTime>>("LastLifeSign", true, false, IbEm.ConcurrencyStrategy.None, false, null);

      /// <summary>The BaseDirectory <see cref="T:IbEm.DataEntityProperty"/>. </summary>
      public static readonly IbEm.DataEntityProperty<BackgroundWorkerStatu, string> BaseDirectory = new IbEm.DataEntityProperty<BackgroundWorkerStatu, string>("BaseDirectory", false, false, IbEm.ConcurrencyStrategy.None, false, null);
    }
    #endregion EntityProperty definitions
    ...
    public new partial class EntityPropertyNames : IbEm.Entity.EntityPropertyNames {
      ...
      public const String Status = "Status";
      public const String LastLifeSign = "LastLifeSign";
  ...
  /// </summary>
  [IbCore.IdeaBladeGuid("dc6f10e6-de7f-45fd-a286-b551abe751c0", "2.1.4")]
  public partial class EntityRelations : IbEm.IEntityRelations {
    ...
    /// <summary>
    /// Represents the relationship between 
    /// <see cref="Store"/> and <see cref="Store"/>.
    /// </summary>
    public static IbEm.EntityRelation FK_Store_Store = new IbEm.EntityRelation(
      typeof(Store),
      typeof(Store),
       new IbEm.DataEntityProperty[] { Store.PropertyMetadata.TransportStoreId},
       new IbEm.DataEntityProperty[] { Store.PropertyMetadata.Id},
      IbEm.Multiplicity.Many,
